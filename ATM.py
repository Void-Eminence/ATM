...
# Puedes instalar mohist despues de instalar forge desde el menu de gestionar
# Puedes instalar paper despues de instalar vanilla desde el menu de gestionar
# Puedes instalar purpur despues de instalar fabric desde el menu de gestionar
